...
import com.panda.shop.weixin.mp.builder.TextBuilder;
...
public class MsgHandler extends AbstractHandler {
	// 用户发送手机验证码提示
	@Value("${panda.shop.weixin.registration.code.message}")
	private String registrationCodeMessage;
	// 默认用户发送验证码提示
	@Value("${panda.shop.weixin.default.registration.code.message}")
