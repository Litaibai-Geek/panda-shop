...
import com.panda.shop.member.controller.req.vo.RegisterVo;
import com.panda.shop.member.feign.MemberRegisterServiceFeign;
...
public class RegisterController extends BaseWebController {
    ...
    public String postRegister(@ModelAttribute("registerVo") @Validated RegisterVo registerVo,
        ...
        UserInpDTO userInpDTO = PandaBeanUtils.voToDto(registerVo, UserInpDTO.class);
